...
public class JiangSuTask implements Runnable {

    private int beginIndex;
    private ConfigParam config;
    static DataContentMapper mapper = SpringContextHolder.getBean("dataContentMapper");
    private static final Logger logger = LoggerFactory.getLogger(JiangSuTask.class);


    public JiangSuTask(int beginIndex, ConfigParam config) {
    ...
    //    data.setPubTime(datadb.getPubTime());
        ...
        data.setDistrictShow(datadb.getRegion());
