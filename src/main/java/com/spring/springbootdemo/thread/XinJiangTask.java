...
public class XinJiangTask implements Runnable {

    private int beginIndex;
    private ConfigParam config;
    static DataContentMapper mapper = SpringContextHolder.getBean("dataContentMapper");
    private static final Logger logger = LoggerFactory.getLogger(XinJiangTask.class);


    public XinJiangTask(int beginIndex, ConfigParam config) {
