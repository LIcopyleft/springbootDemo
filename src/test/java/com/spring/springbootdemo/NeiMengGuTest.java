...
import com.spring.springbootdemo.thread.NeiMengGuTask;
...
//    private static final Logger logger = LoggerFactory.getLogger(GOVDataCleanTest.class// private static final String STAGE_SHOW = "招标/资审文件澄清";
    ...
    private static final String CLEAN_TABLE_NAME = "spider_6_ggzy_neimenggu_content";
    ...
    public void clean() throws InterruptedException {
        ...
        for (int i = 0; i < times; i++) {
            Runnable task = new NeiMengGuTask(beginIndex, config);
