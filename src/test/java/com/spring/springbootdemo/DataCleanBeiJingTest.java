...
public class DataCleanBeiJingTest {
    private static final ExecutorService EXECUTOR = Executors.newFixedThreadPool(30);
    private static final Logger logger = LoggerFactory.getLogger(DataCleanBeiJingTest.class);
...
//交易结果公示
    ...
    //    List<Runnable> tasks = new ArrayList<Runnable>();//添加任务
        for(int i = 0; i <times ; i++){
            Runnable task = new CleanBeiJingTask(beginIndex,QUERY_SIZE,STAGE_SHOW,latch);
        //    tasks.add(task);
