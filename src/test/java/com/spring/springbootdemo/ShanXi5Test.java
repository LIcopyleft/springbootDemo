...
import com.spring.springbootdemo.thread.ShanXi5Task;
...
//    private static final Logger logger = LoggerFactory.getLogger(GOVDataCleanTest.class// private static final String STAGE_SHOW = "招标/资审文件澄清";
    ...
    private static final String STAGE = "zfcg";
    ...
    private static final String CLEAN_TABLE_NAME = "spider_5_ggzy_shanxi_content";
    private static final String UNION_TABLE_NAME = "spider_5_ggzy_shanxi_url";
      ...
      //     int totalSize = 4448;//mapper.getTotal();
       int totalSize = mapper.countNum(CLEAN_TABLE_NAME);
        ...
        for (int i = 0; i < times; i++) {
            Runnable task = new ShanXi5Task(beginIndex, config);
