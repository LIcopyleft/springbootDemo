...
import com.spring.springbootdemo.thread.GuiZhouTask;
...
//    private static final Logger logger = LoggerFactory.getLogger(GOVDataCleanTest.class// private static final String STAGE_SHOW = "招标/资审文件澄清";
    ...
    private static Integer MAX_THREAD_NUM = 8;
    ...
    private static final String CLEAN_TABLE_NAME = "spider_22_ggzy_guizhou_content";
    private static final String UNION_TABLE_NAME = "spider_22_ggzy_guizhou_url";
   ...
   //        int totalSize = 4448;//mapper.getTotal();
        ...
        for (int i = 0; i < times; i++) {
            Runnable task = new GuiZhouTask(beginIndex, config);
