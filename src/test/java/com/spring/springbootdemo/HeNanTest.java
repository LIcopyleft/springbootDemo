...
import com.spring.springbootdemo.thread.ShanXiTask;
...
//    private static final Logger logger = LoggerFactory.getLogger(GOVDataCleanTest.class// private static final String STAGE_SHOW = "招标/资审文件澄清";
    ...
    private static final String CLEAN_TABLE_NAME = "spider_14_ggzy_henan_url";
    private static final String UNION_TABLE_NAME = "spider_14_ggzy_henan_content";
    ...
    public void clean() throws InterruptedException {
     ...
     //   int totalSize = mapper.countNum(CLEAN_TABLE_NAME);
        ...
        for (int i = 0; i < times; i++) {
            Runnable task = new HeNanTask(beginIndex, config);
