...
import com.spring.springbootdemo.thread.GanSuTask;
...
//    private static final Logger logger = LoggerFactory.getLogger(GOVDataCleanTest.class// private static final String STAGE_SHOW = "招标/资审文件澄清";
    ...
    private static final String CLEAN_TABLE_NAME = "spider_26_ggzy_gansu_content";
    ...
    public void clean() throws InterruptedException {
        ...
        for (int i = 0; i < times; i++) {
            Runnable task = new GanSuTask(beginIndex, config);
